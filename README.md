...
This project is part of the Udacity Cloud Developer Nanodegree program. It is a simple TODO application implemented using AWS Lambda and Serverless framework. 
...
The application also stores the id of the user who created a TODO item.
